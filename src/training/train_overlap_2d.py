...
OVERLAP_ROOT = Path(os.environ.get("OVERLAP2D_ROOT", PROJECT_ROOT / "overlaps" / "2d"))
...
OUTPUT_DIR = Path(os.environ.get("OUTPUT_OVERLAP_2D2_ROOT", PROJECT_ROOT / "outputs" / "overlap_2d"))
